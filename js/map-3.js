...
for (매장 of 스타벅스매장리스트) {
    ...
    kakao.maps.event.addListener(마커, 'mouseover', 마우스오버시(기준지도, 마커, 정보창));
    // 마커에서 마우스아웃하면 makeOutListener() 실행
    kakao.maps.event.addListener(마커, 'mouseout', 마우스아웃시(정보창));
}
