...
//  로컬스토리지삭제(li)콜링이 되므로, 삭제할할일로 들어오는 대상은 li
...
/**
 * 로컬스토리지의 내용은 브라우저를 꺼도 나타나므로, DB를 활용하면 좋겠지만 그렇지 못하는 경우에는 남아있는 로컬스토리지의 내용을 화면에 표시하는것을 처음 로딩에 걸어두면 완성도가 높아보인다.
 */
